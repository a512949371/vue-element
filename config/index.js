...
module.exports = {
  ...
  dev: { // 开发环境
    ...
    autoOpenBrowser: false, // 是否自动打开浏览器。true 是，false 否
    assetsSubDirectory: 'static', // 应用程序存放的资源主目录 
    assetsPublicPath: '/', // 编译发布的根目录，可配置为资源服务器域名或 CDN 域名
     proxyTable: {
//	   '/api':{
//	     target:"http://192.168.1.115:9104/xdjCore/xdjAdminCore/",//设置你调用的接口域名和端口号 别忘了加http
//	     changeOrigin:true,
//	     pathRewrite:{
//	       '^/api':'/'//这里理解成用‘/api'代替target里面的地址，后面组件中我们掉接口时直接用api代替 
	            //比如我要调用'http://192.168.1.115:9104/xdjCore/xdjAdminCore/'，直接写‘/api/user/login'即可
//	     }
//	   }
	  },
